...
export const GENERAL_CASE_CONFIG_TYPE = {
...
export const GENERAL_CONSENT_MANAGEMENT_LIST = [
  'CONSENT_PRODUCT',
  'CONSENT_SERVICE',
  'CONSENT_STATUS',
];

export const GENERAL_CONSENT_CONFIG_TYPE = {
  CONSENT_PRODUCT: 'CONSENT_PRODUCT',
