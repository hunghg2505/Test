  ...
  return (
    <Document language='Thailand'>
      <Page size='A3' style={styles.page}>
        ...
        <Text style={styles.subTitle}>แบบฟอร์มแจ้งผลการใช้สิทธิของเจ้าของข้อมูลส่วนบุคคล</Text>
        ...
        <Text style={styles.text}>
          ...
          ได้รับคำขอใช้สิทธิของท่านในฐานะเจ้าของข้อมูลส่วนบุคคลตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล
          พ.ศ. 2562 บริษัทฯขอแจ้งให้ท่านทราบถึงผลการพิจารณาคำขอ ดังต่อไปนี้
        </Text>

        <Text style={styles.label}>Request information/ข้อมูลคำขอที่เราได้รับ:</Text>
        <View style={styles.table}>
          <View style={styles.tableRow}>
            <View style={styles.tableCol}>
              <Text style={styles.tableCell}>Full name of data subject</Text>
              <Text style={styles.tableCell}>ชื่อ นามสกุล ของเจ้าของข้อมูลส่วนบุคคล</Text>
            </View>
            <View style={styles.tableCol}>
          ...
          <View style={styles.tableRow}>
            <View style={styles.tableCol}>
              ...
              <Text style={styles.tableCell}>สิทธิตามที่ท่านได้ยื่นคำขอ (โดยสรุป)</Text>
            </View>
            <View style={styles.tableCol}>
        ...
        <Text style={styles.label}>Result/ผลการพิจารณาดำเนินการตามคำขอ:</Text>
        <View>
          <View style={styles.checkboxContainer}>
            ...
            <Text>Accept the request / ยอมรับดำเนินการตามคำร้องขอ</Text>
          </View>
          <Text>Actions according to the request / รายละเอียดการดำเนินการตามคำขอ</Text>
          <Text style={styles.text}>
        ...
        <View style={{ marginTop: 10, display: 'flex' }}>
          <View style={styles.checkboxContainer}>
            ...
            <Text>Reject the request / ปฏิเสธการดำเนินการตามคำขอ</Text>
          </View>
          <Text>Reason of rejection / เหตุผลในการปฏิเสธ:</Text>
          <Text style={styles.text}>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <Text>หากท่านมีคำถามเพิ่มเติม สามารถติดต่อเราได้ที่ {caseData?.companyInfo?.email}</Text>
        </View>
        <View>
